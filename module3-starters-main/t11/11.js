...
for (let image of picArray) {
  ...
  img.setAttribute('src', `${image['image']['medium']}`);
  ...
  article.addEventListener('click', function() {
    let large_img = document.querySelector('dialog img');
    let dialog = document.querySelector('dialog');
    large_img.setAttribute('src', `${image['image']['large']}`);
